       ...
       */
            ...
            if ( (string)linkedListNode.Value == "sad")
       {
        ...
        private void Button5__Click(object sender, EventArgs e)
        {
            ...
            LinkedListNode<object> current1 = linkedListNode1.Previous;
            LinkedListNode<object> current2 = linkedListNode2.Previous;

            linkedList.Remove(linkedListNode1);
            linkedList.AddBefore(current1, linkedListNode1);
            linkedList.Remove(linkedListNode2);
            linkedList.AddBefore(current2, linkedListNode2);

            linkedListNode1 = linkedList.Find("mainly");
            linkedListNode2 = linkedList.Find("plain");
            LinkedListNode<object> current3 = linkedListNode1.Previous;
            LinkedListNode<object> current4 = linkedListNode2.Next;

            linkedList.Remove(linkedListNode1);
            linkedList.AddBefore(current3, linkedListNode1);
            //current3 = linkedListNode1.Previous;
            linkedList.Remove(linkedListNode1);
            linkedList.AddBefore(current3, linkedListNode1);

            linkedList.Remove(linkedListNode2);
            linkedList.AddAfter(current4, linkedListNode2);
             current4 = linkedListNode2.Next;
            linkedList.Remove(linkedListNode2);
            linkedList.AddAfter(current4, linkedListNode2);
             current4 = linkedListNode2.Next;
            linkedList.Remove(linkedListNode2);
        ...
        private void Button6__Click(object sender, EventArgs e)
        {
            ...
            anagram.AddBefore(current1, linkedListNode1);
            current1 = linkedListNode1.Previous;
            anagram.Remove(linkedListNode1);
            anagram.AddBefore(current1, linkedListNode1);
            current1 = linkedListNode1.Previous;
            anagram.Remove(linkedListNode1);                          // Move up "R", "I"
            anagram.AddBefore(current1, linkedListNode1);
            current1 = linkedListNode1.Previous;
            anagram.Remove(linkedListNode2);
            anagram.AddBefore(current2, linkedListNode2);

            linkedListNode1 = anagram.Find("T");
            linkedListNode2 = anagram.Find("Y");
            current1 = linkedListNode1.Previous;
            current2 = linkedListNode2.Previous;
            anagram.Remove(linkedListNode1);
            anagram.AddBefore(current1, linkedListNode1);
            current1 = linkedListNode1.Previous;                      // Move up "T", "Y" to start with "DIRTY"
            anagram.Remove(linkedListNode1);
            anagram.AddBefore(current1, linkedListNode1);
            anagram.Remove(linkedListNode2);
            anagram.AddBefore(current2, linkedListNode2);
            ...
            anagram.AddBefore(current1, linkedListNode1);
            current1 = linkedListNode1.Previous;
            anagram.Remove(linkedListNode1);                           // Swap the final R's and O's to form "ROOM"
            anagram.AddBefore(current1, linkedListNode1);
            current1 = linkedListNode1.Previous;
            anagram.Remove(linkedListNode1);
            anagram.AddBefore(current1, linkedListNode1);
